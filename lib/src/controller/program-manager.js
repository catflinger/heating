...
var ProgramManager = (function () {
    ...
    Object.defineProperty(ProgramManager.prototype, "currentProgram", {
        get: function () {
            var id;
    ...
    ProgramManager.prototype.getConfig = function () {
        return Object.assign(new types_1.ProgramConfig(), this._config);
    };
    ProgramManager.prototype.configIsValid = function (config) {
    ...
    ProgramManager.prototype.setConfig = function (config) {
        this._config = config;
        this.save();
    };
