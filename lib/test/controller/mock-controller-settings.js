...
var MockControllerSettings = (function () {
    function MockControllerSettings() {
        ...
        this.programStoreDir = path.join(__dirname, "data");
        this.debugDir = path.join(__dirname, "..", "..", "..", "test", "debug");
        this.boilerPath = path.join(__dirname, "data", "gpio", "gpio16", "value");
        this.chPumpPath = path.join(__dirname, "data", "gpio", "gpio20", "value");
        this.hwPumpPath = path.join(__dirname, "data", "gpio", "gpio21", "value");
    }
