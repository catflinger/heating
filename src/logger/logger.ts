...
export class Logger implements ILogger {
    ...
    private envController: IEnvironment;
    ...
    public start(): void {
        ...
        this.loggingJob = scheduleJob("00 00,05,10,15,20,25,30,35,40,45,50,55 * * *", this.writeLogEntry);

        // schedule housekeep at just after midnight every day
        this.housekeepingJob = scheduleJob("02 00 * * *", this.writeLogEntry);
    }
